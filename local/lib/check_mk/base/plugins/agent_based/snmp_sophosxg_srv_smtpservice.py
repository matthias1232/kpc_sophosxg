...
def discover_sophosxg_srv_smtpservice(section):
    yield Service()


def check_sophosxg_srv_smtpservice(section):
...
register.check_plugin(
    ...
    discovery_function=discover_sophosxg_srv_smtpservice,
    check_function=check_sophosxg_srv_smtpservice,
)
