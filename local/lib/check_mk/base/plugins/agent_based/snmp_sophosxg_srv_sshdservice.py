...
def discover_sophosxg_srv_sshdservice(section):
    yield Service()


def check_sophosxg_srv_sshdservice(section):
...
register.check_plugin(
    name="sophosxg_srv_sshdservice",
    service_name="Service SSHd",
    discovery_function=discover_sophosxg_srv_sshdservice,
    check_function=check_sophosxg_srv_sshdservice,
)
