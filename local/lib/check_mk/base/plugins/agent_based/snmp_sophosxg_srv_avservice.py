...
def discover_sophosxg_srv_avservice(section):
    yield Service()


def check_sophosxg_srv_avservice(section):
...
register.check_plugin(
    name="sophosxg_srv_avservice",
    service_name="Service AV",
    discovery_function=discover_sophosxg_srv_avservice,
    check_function=check_sophosxg_srv_avservice,
)
