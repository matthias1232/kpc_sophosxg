...
register.snmp_section(
    name="sophosxg_srv_imap4service",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_imap4service(section):
    yield Service()


def check_sophosxg_srv_imap4service(section):
...
register.check_plugin(
    name="sophosxg_srv_imap4service",
    service_name="Service IMAP4",
    discovery_function=discover_sophosxg_srv_imap4service,
    check_function=check_sophosxg_srv_imap4service,
)
