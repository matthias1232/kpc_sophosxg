...
register.snmp_section(
    name="sophosxg_lic_webserverprotection",
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.2604.5.1.5.5",
        oids = [
        "1",
        "2",
        ],
...
def discover_sophosxg_lic_webserverprotection(section):
    yield Service()


def check_sophosxg_lic_webserverprotection(params, section):
    warn = params["warning_web_Server_rotection"][0]
    crit = params["warning_web_Server_rotection"][1]
    unlicensed = params["warning_web_Server_rotection"][2]
    evallicense = params["warning_web_Server_rotection"][3]
    deactivatedlicense = params["warning_web_Server_rotection"][4]
...
register.check_plugin(
    name="sophosxg_lic_webserverprotection",
    service_name="License Web Server Protection",
    discovery_function=discover_sophosxg_lic_webserverprotection,
    check_function=check_sophosxg_lic_webserverprotection,
    check_default_parameters={'warning_web_Server_rotection' : (40,30,"CRIT","WARN","CRIT")},
