...
register.snmp_section(
    name="sophosxg_srv_networkservice",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_networkservice(section):
    yield Service()


def check_sophosxg_srv_networkservice(section):
...
register.check_plugin(
    ...
    discovery_function=discover_sophosxg_srv_networkservice,
    check_function=check_sophosxg_srv_networkservice,
)
