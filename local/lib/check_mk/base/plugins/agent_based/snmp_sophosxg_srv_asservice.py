...
def discover_sophosxg_srv_asservice(section):
    yield Service()


def check_sophosxg_srv_asservice(section):
...
register.check_plugin(
    name="sophosxg_srv_asservice",
    service_name="Service AS",
    discovery_function=discover_sophosxg_srv_asservice,
    check_function=check_sophosxg_srv_asservice,
)
