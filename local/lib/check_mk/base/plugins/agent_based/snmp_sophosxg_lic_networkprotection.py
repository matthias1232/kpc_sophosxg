...
register.snmp_section(
    name="sophosxg_lic_networkprotection",
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.2604.5.1.5.2",
        oids = [
        "1",
        "2",
        ],
...
def discover_sophosxg_lic_networkprotection(section):
    yield Service()


def check_sophosxg_lic_networkprotection(params, section):
    warn = params["warning_network_protection"][0]
    crit = params["warning_network_protection"][1]
    unlicensed = params["warning_network_protection"][2]
    evallicense = params["warning_network_protection"][3]
    deactivatedlicense = params["warning_network_protection"][4]
...
register.check_plugin(
    name="sophosxg_lic_networkprotection",
    service_name="License Network Protection",
    discovery_function=discover_sophosxg_lic_networkprotection,
    check_function=check_sophosxg_lic_networkprotection,
    check_default_parameters={'warning_network_protection' : (40,30,"CRIT","WARN","CRIT")},
