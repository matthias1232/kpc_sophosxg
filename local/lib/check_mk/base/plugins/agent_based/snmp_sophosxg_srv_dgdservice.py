...
def discover_sophosxg_srv_dgdservice(section):
    yield Service()


def check_sophosxg_srv_dgdservice(section):
...
register.check_plugin(
    name="sophosxg_srv_dgdservice",
    service_name="Service DGD",
    discovery_function=discover_sophosxg_srv_dgdservice,
    check_function=check_sophosxg_srv_dgdservice,
)
