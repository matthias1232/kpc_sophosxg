...
register.snmp_section(
    name="sophosxg_srv_sslvpnservice",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_sslvpnservice(section):
    yield Service()


def check_sophosxg_srv_sslvpnservice(section):
...
register.check_plugin(
    name="sophosxg_srv_sslvpnservice",
    service_name="Service SSL VPN",
    discovery_function=discover_sophosxg_srv_sslvpnservice,
    check_function=check_sophosxg_srv_sslvpnservice,
)
