...
register.snmp_section(
    name="sophosxg_lic_zerodayprotection",
    fetch=SNMPTree(
...
def discover_sophosxg_lic_zerodayprotection(section):
    yield Service()


def check_sophosxg_lic_zerodayprotection(params, section):
    warn = params["warning_zero_day_protection"][0]
    crit = params["warning_zero_day_protection"][1]
    unlicensed = params["warning_zero_day_protection"][2]
    evallicense = params["warning_zero_day_protection"][3]
    deactivatedlicense = params["warning_zero_day_protection"][4]
...
register.check_plugin(
    name="sophosxg_lic_zerodayprotection",
    service_name="License Zero-Day Protection",
    discovery_function=discover_sophosxg_lic_zerodayprotection,
    check_function=check_sophosxg_lic_zerodayprotection,
    check_default_parameters={'warning_zero_day_protection' : (40,30,"CRIT","WARN","CRIT")},
