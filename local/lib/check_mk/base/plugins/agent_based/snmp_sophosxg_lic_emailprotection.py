...
register.snmp_section(
    name="sophosxg_lic_emailprotection",
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.2604.5.1.5.4",
        oids = [
        "1",
        "2",
        ],
...
def discover_sophosxg_lic_emailprotection(section):
    yield Service()


def check_sophosxg_lic_emailprotection(params, section):
    warn = params["warning_email_protection"][0]
    crit = params["warning_email_protection"][1]
    unlicensed = params["warning_email_protection"][2]
    evallicense = params["warning_email_protection"][3]
    deactivatedlicense = params["warning_email_protection"][4]
...
register.check_plugin(
    name="sophosxg_lic_emailprotection",
    service_name="License Email Protection",
    discovery_function=discover_sophosxg_lic_emailprotection,
    check_function=check_sophosxg_lic_emailprotection,
    check_default_parameters={'warning_email_protection' : (40,30,"CRIT","WARN","CRIT")},
