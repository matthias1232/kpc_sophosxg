...
register.snmp_section(
    name="sophosxg_lic_basefw",
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.2604.5.1.5.1",
        oids = [
        "1",
        "2",
        ],
...
def discover_sophosxg_lic_basefw(section):
    yield Service()


def check_sophosxg_lic_basefw(params, section):
    warn = params["warning_base_firewall"][0]
    crit = params["warning_base_firewall"][1]
    unlicensed = params["warning_base_firewall"][2]
    evallicense = params["warning_base_firewall"][3]
    deactivatedlicense = params["warning_base_firewall"][4]
...
register.check_plugin(
    name="sophosxg_lic_basefw",
    service_name="License Base Firewall",
    discovery_function=discover_sophosxg_lic_basefw,
    check_function=check_sophosxg_lic_basefw,
    check_default_parameters={'warning_base_firewall' : (40,30,"CRIT","WARN","CRIT")},
