...
def discover_sophosxg_srv_ipsservice(section):
    yield Service()


def check_sophosxg_srv_ipsservice(section):
...
register.check_plugin(
    name="sophosxg_srv_ipsservice",
    service_name="Service IPS",
    discovery_function=discover_sophosxg_srv_ipsservice,
    check_function=check_sophosxg_srv_ipsservice,
)
