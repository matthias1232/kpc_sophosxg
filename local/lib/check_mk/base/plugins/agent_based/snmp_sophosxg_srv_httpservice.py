...
def discover_sophosxg_srv_httpservice(section):
    yield Service()


def check_sophosxg_srv_httpservice(section):
...
register.check_plugin(
    ...
    discovery_function=discover_sophosxg_srv_httpservice,
    check_function=check_sophosxg_srv_httpservice,
)
