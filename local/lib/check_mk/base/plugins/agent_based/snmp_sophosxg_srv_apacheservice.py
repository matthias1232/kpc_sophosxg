...
register.snmp_section(
    name="sophosxg_srv_apacheservice",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_apacheservice(section):
    yield Service()


def check_sophosxg_srv_apacheservice(section):
...
register.check_plugin(
    name="sophosxg_srv_apacheservice",
    service_name="Service Apache",
    discovery_function=discover_sophosxg_srv_apacheservice,
    check_function=check_sophosxg_srv_apacheservice,
)
