...
register.snmp_section(
    name="sophosxg_lic_enhancedplussupport",
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.2604.5.1.5.8",
        oids = [
        "1",
        "2",
        ],
...
def discover_sophosxg_lic_enhancedplussupport(section):
    yield Service()


def check_sophosxg_lic_enhancedplussupport(params, section):
    warn = params["warning_enhanced_plus_support"][0]
    crit = params["warning_enhanced_plus_support"][1]
    unlicensed = params["warning_enhanced_plus_support"][2]
    evallicense = params["warning_enhanced_plus_support"][3]
    deactivatedlicense = params["warning_enhanced_plus_support"][4]
...
register.check_plugin(
    name="sophosxg_lic_enhancedplussupport",
    service_name="License Enhanced Plus Support",
    discovery_function=discover_sophosxg_lic_enhancedplussupport,
    check_function=check_sophosxg_lic_enhancedplussupport,
    check_default_parameters={'warning_enhanced_plus_support' : (40,30,"CRIT","WARN","CRIT")},
