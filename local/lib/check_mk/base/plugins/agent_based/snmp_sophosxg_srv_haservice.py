...
def discover_sophosxg_srv_haservice(section):
    yield Service()


def check_sophosxg_srv_haservice(section):
...
register.check_plugin(
    name="sophosxg_srv_haservice",
    service_name="Service HA",
    discovery_function=discover_sophosxg_srv_haservice,
    check_function=check_sophosxg_srv_haservice,
)
