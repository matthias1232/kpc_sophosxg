...
register.snmp_section(
    name="sophosxg_srv_databaseservice",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_databaseservice(section):
    yield Service()


def check_sophosxg_srv_databaseservice(section):
...
register.check_plugin(
    name="sophosxg_srv_databaseservice",
    service_name="Service Database",
    discovery_function=discover_sophosxg_srv_databaseservice,
    check_function=check_sophosxg_srv_databaseservice,
)
