...
register.snmp_section(
    name="sophosxg_srv_garnerservice",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_garnerservice(section):
    yield Service()


def check_sophosxg_srv_garnerservice(section):
...
register.check_plugin(
    name="sophosxg_srv_garnerservice",
    service_name="Service Garner",
    discovery_function=discover_sophosxg_srv_garnerservice,
    check_function=check_sophosxg_srv_garnerservice,
)
