...
register.snmp_section(
    name="sophosxg_srv_droutingservice",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_droutingservice(section):
    yield Service()


def check_sophosxg_srv_droutingservice(section):
...
register.check_plugin(
    name="sophosxg_srv_droutingservice",
    service_name="Service DRouting",
    discovery_function=discover_sophosxg_srv_droutingservice,
    check_function=check_sophosxg_srv_droutingservice,
)
