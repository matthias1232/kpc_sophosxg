...
register.snmp_section(
    name="sophosxg_lic_centralorchestration",
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.2604.5.1.5.9",
        oids = [
        "1",
        "2",
        ],
...
def discover_sophosxg_lic_centralorchestration(section):
    yield Service()


def check_sophosxg_lic_centralorchestration(params, section):
    warn = params["warning_central_orchestration"][0]
    crit = params["warning_central_orchestration"][1]
    unlicensed = params["warning_central_orchestration"][2]
    evallicense = params["warning_central_orchestration"][3]
    deactivatedlicense = params["warning_central_orchestration"][4]
...
register.check_plugin(
    name="sophosxg_lic_centralorchestration",
    service_name="License Central Orchestration",
    discovery_function=discover_sophosxg_lic_centralorchestration,
    check_function=check_sophosxg_lic_centralorchestration,
    check_default_parameters={'warning_central_orchestration' : (40,30,"CRIT","WARN","CRIT")},
