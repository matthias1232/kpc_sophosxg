...
def discover_sophosxg_srv_dnsservice(section):
    yield Service()


def check_sophosxg_srv_dnsservice(section):
...
register.check_plugin(
    ...
    discovery_function=discover_sophosxg_srv_dnsservice,
    check_function=check_sophosxg_srv_dnsservice,
)
