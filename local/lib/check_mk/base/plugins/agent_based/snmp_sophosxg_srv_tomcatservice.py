...
register.snmp_section(
    name="sophosxg_srv_tomcatservice",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_tomcatservice(section):
    yield Service()


def check_sophosxg_srv_tomcatservice(section):
...
register.check_plugin(
    ...
    discovery_function=discover_sophosxg_srv_tomcatservice,
    check_function=check_sophosxg_srv_tomcatservice,
)
