...
def discover_sophosxg_srv_pop3service(section):
    yield Service()


def check_sophosxg_srv_pop3service(section):
...
register.check_plugin(
    name="sophosxg_srv_pop3service",
    service_name="Service POP3",
    discovery_function=discover_sophosxg_srv_pop3service,
    check_function=check_sophosxg_srv_pop3service,
)
