...
register.snmp_section(
    name="sophosxg_srv_ipsecvpnservice",
    fetch=SNMPTree(
...
def discover_sophosxg_srv_ipsecvpnservice(section):
    yield Service()


def check_sophosxg_srv_ipsecvpnservice(section):
...
register.check_plugin(
    name="sophosxg_srv_ipsecvpnservice",
    service_name="Service IPSec VPN",
    discovery_function=discover_sophosxg_srv_ipsecvpnservice,
    check_function=check_sophosxg_srv_ipsecvpnservice,
)
