...
def check_sophosxg_lic_webprotection(params, section):
    warn = params["warning_web_rotection"][0]
    crit = params["warning_web_rotection"][1]
    unlicensed = params["warning_web_rotection"][2]
    evallicense = params["warning_web_rotection"][3]
    deactivatedlicense = params["warning_web_rotection"][4]
...
register.check_plugin(
    ...
    check_default_parameters={'warning_web_rotection' : (40,30,"CRIT","WARN","CRIT")},
